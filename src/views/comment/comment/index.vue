<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="100px">
      ...
      <el-form-item label="文章用户id" prop="articleUserId">
        <el-input
          v-model="queryParams.articleUserId"
          placeholder="请输入文章用户id"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="评论状态" prop="checkFlag">
        <el-select v-model="queryParams.checkFlag" placeholder="请选择评论状态" clearable>
          <el-option
            v-for="dict in dict.type.check_flag"
            :key="dict.value"
            :label="dict.label"
            :value="dict.value"
          />
      ...
      <el-form-item label="置顶" prop="upFlag">
        <el-select v-model="queryParams.upFlag" placeholder="请选择置顶" clearable>
          <el-option
    ...
    <el-table v-loading="loading" :data="commentList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="文章用户id" align="center" prop="articleUserId" />
      <el-table-column label="评论状态" align="center" prop="checkFlag">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.check_flag" :value="scope.row.checkFlag"/>
        </template>
      </el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="open" width="1000px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        ...
        <el-row>
          ...
          <el-col :span="8"> 
            <el-form-item label="文章用户id" prop="articleUserId">
              <el-input v-model="form.articleUserId" placeholder="请输入文章用户id" />
            </el-form-item>
          </el-col>
          <el-col :span="8"> 
            <el-form-item label="评论状态" prop="checkFlag">
              <el-select v-model="form.checkFlag" placeholder="请选择评论状态">
                <el-option
                  v-for="dict in dict.type.check_flag"
                  :key="dict.value"
                  :label="dict.label"
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除文章评论 编号为"' + ids + '"的数据项？').then(function() {
