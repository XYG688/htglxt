...
import {getDjylLists, deleteDjyl, commentreplyDjyl} from "@/api/partyBuilding";
...
export default {
    ...
    methods: {
        fn_getDjylLists() {
            ...
            getDjylLists(param, data).then(res => {
                if (res.code === 200) {
        ...
        submitReply() {
            ...
            commentreplyDjyl(param).then(res => {
                if (res.code === 200) {
                    this.$message({
                        type: 'success',
                        message: '回复成功'
