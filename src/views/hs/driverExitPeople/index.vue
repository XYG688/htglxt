    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          icon="el-icon-delete"
          :disabled="multiple"
          v-hasPermi="['permit:driverExitPeople:remove']"
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleAudit"
          v-hasPermi="['permit:driverExitPeople:audit']"
        >一键审核
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleReject"
          v-hasPermi="['permit:driverExitPeople:reject']"
        >一键驳回
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          @click="handleExport"
          v-hasPermi="['permit:driverExitPeople:export']"
        >导出
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleSet"
          v-hasPermi="['permit:driverExitPeople:set']"
        >设置
        </el-button>
      </el-col>
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width" width="180" fixed="right">
        <template slot-scope="scope">
          ...
          <el-button
            ...
            v-hasPermi="['permit:driverExitPeople:edit']"
          >修改
          </el-button>
          <el-button
            size="mini"
...
import {
  getMassesDriver, saveMasses, massesDel, batchAuditl, getGrid, getOutReportInfo
...
// 表单重置
    ...
    getList() {
      ...
      getMassesDriver(this.queryParams).then(response => {
    ...
    handleExport() {
      this.$confirm('是否导出全部数据?', '提示', {
        ...
        this.download('/ur/v2/out/reportDriver/list/export', {
          ...this.queryParams
